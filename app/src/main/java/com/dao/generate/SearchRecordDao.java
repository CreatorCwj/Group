...
public class SearchRecordDao extends AbstractDao<SearchRecord, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property LastUseTime = new Property(2, long.class, "lastUseTime", false, "LAST_USE_TIME");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SEARCH_RECORD\" (" + //
                ...
                "\"LAST_USE_TIME\" INTEGER NOT NULL );"); // 2: lastUseTime
    }
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, SearchRecord entity) {
        stmt.clearBindings();
        ...
        stmt.bindLong(3, entity.getLastUseTime());
    }
    ...
    public SearchRecord readEntity(Cursor cursor, int offset) {
        SearchRecord entity = new SearchRecord( //
            ...
            cursor.getLong(offset + 2) // lastUseTime
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, SearchRecord entity, int offset) {
        ...
        entity.setLastUseTime(cursor.getLong(offset + 2));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(SearchRecord entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
