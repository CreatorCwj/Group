 ...
 * 评论adapter
 */
public class RemarkAdapter extends RecyclerViewAdapter<Remark> implements LoadMoreRecyclerView.OnItemClickListener,LoadMoreRecyclerView.OnItemLongClickListener{
